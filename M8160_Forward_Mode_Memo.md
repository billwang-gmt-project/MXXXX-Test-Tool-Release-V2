...
- `(500, 4000)` → ratio 2.54 失敗（500 > 474.98）；ratio 3.72 通過（500 < 695.64、4000 < 4013.88）→ **idx=1**
- `(1000, 4000)` → ratio 2.54/3.72 失敗；ratio 5.59 通過（1000 < 1045.33、4000 < 6031.61）→ **idx=2**
- `(600, 2500)`（觸發舊 bug）→ 舊邏輯選 ratio 2.54（誤），新邏輯 ratio 2.54 失敗（600 > 474.98）→ ratio 3.72 通過 → **idx=1**
